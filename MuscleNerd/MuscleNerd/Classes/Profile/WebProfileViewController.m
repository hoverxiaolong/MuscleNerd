...
#define BDURL @"https://wap.koudaitong.com/v2/feature/1c4bmdfu9?redirect_count=1"
#define width [[UIScreen mainScreen]bounds].size.width
#define Height [[UIScreen mainScreen]bounds].size.height
@interface WebProfileViewController ()<UIWebViewDelegate>
@property (nonatomic, strong)UIButton *backbutton;
@property (nonatomic, strong)UIButton *nextPageButton;
@end

@implementation WebProfileViewController
- (void)loadView {
